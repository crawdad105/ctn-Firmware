...
> [!NOTE]
> GPLv3 because Luma3DS is and its required. Custom works/files can either be found under [Luma3DS_Mod/sysmodules/rosalina/source/ctn](Luma3DS_Mod/sysmodules/rosalina/source/ctn) or [Luma3DS_Mod/sysmodules/rosalina/include/ctn](Luma3DS_Mod/sysmodules/rosalina/include/ctn). Modified work/files should be found by searching for `sponge` (shout out Terry Davis, rest in peace), its possible i modified something a long time ago and forgot. 